...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<?php echo mvc::$cfg['PATH_HUI_ADMIN'];?>lib/My97DatePicker/4.8/WdatePicker.js"></script> 
<script type="text/javascript" src="<?php echo mvc::$cfg['PATH_HUI_ADMIN'];?>lib/datatables/1.10.0/jquery.dataTables.min.js"></script> 
<script type="text/javascript" src="<?php echo mvc::$cfg['PATH_HUI_ADMIN'];?>lib/laypage/1.2/laypage.js"></script>
